...
public class Contenedor_negocios<T>
{
    private List<T> Datos_negocios = new List<T>();

    public void Agregar_dato(T objeto)
    {

        Datos_negocios.Add(objeto);
    ...
    public void Imprimir_datos(Type tipo)
    {
        ...
        foreach (T elemento in Datos_negocios)
        {
    ...
    {
        Datos_negocios.Remove(elemento);
